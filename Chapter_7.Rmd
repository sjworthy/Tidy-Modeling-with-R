...
1. encourages good methodology since it is a single point of engry to the estimatation components of a data analysis.
...
These represntations can be crossed with one or more models using the workflow_set() function. We'll just use the previous linear model specifications to demonstrate:
